...
<Card title="Non-Interactive Mode Reference" icon="robot" href="/cli/non-interactive-mode">
  Complete guide to automating CLI commands for AI IDEs, CI/CD, and scripting
</Card>
