...
<Note>
  **New in v3.6.0:** 📊 **Anonymous telemetry** — lua-cli now collects anonymous usage data to help improve the developer experience. Opt out anytime with `lua telemetry off` or `LUA_TELEMETRY=false`.
</Note>
...
| `lua telemetry`  | ⚙️ Utilities      | Manage anonymous usage data collection                                      | ✅ Direct       |
