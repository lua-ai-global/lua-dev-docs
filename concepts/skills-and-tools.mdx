...
- Always mention daily specials`,
  ...
  welcomeMessage: "Welcome to Java Junction! What can I brew for you today?",
...
- ✅ **Single source of truth** - All agent config in one place
- ✅ **Better organization** - Clear separation of persona, skills, webhooks, jobs
- ✅ **Auto-sync** - Automatically syncs with `lua.skill.yaml`
