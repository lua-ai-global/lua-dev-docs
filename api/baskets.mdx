...
```typescript
Baskets.create(data: BasketInput): Promise<BasketInstance>
```
...
```typescript
Baskets.addItem(basketId: string, item: BasketItem): Promise<BasketInstance>
```
...
**Returns:** `BasketInstance` with updated item count and total
