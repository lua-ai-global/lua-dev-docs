...
<ParamField path="userId" type="string">
  User ID to retrieve a specific user
  ...
  **Optional in:** Tools, dynamic jobs (has conversational context)
  ...
  If not provided, retrieves the current user from the conversation context
</ParamField>
...
| Context | Method | userId Required? | Why |
|---------|--------|------------------|-----|
| **Tools** | `User.get()` | ❌ Optional | Has conversational context |
| **Webhooks** | `User.get(userId)` | ✅ **REQUIRED** | No conversational context |
| **LuaJob** | `User.get(userId)` | ✅ **REQUIRED** | No conversational context |
