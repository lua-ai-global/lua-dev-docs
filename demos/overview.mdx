---
title: "Demo Gallery"
description: "14 production-ready solutions showcasing Lua's flexibility across business and IoT"
---

## Overview

Explore 14 complete, production-ready AI agent implementations across different industries and IoT use cases. Each demo shows full TypeScript code using the **v3.0.0 LuaAgent pattern** with external APIs, Lua Platform APIs, and edge computing.
...
<CardGroup cols={2}>
  ...
  <Card title="IoT & Edge Computing" icon="microchip">
    3 demos for Raspberry Pi and hardware control
  </Card>
...
<Tabs>
  ...
  <Tab title="Edge Computing">
    **IoT Smart Light, Greenhouse, Camera**
    
    Custom Edge APIs on Raspberry Pi
    - Flask APIs for GPIO, sensors, camera
    - Local network communication
    - Hardware control via chat
    
    Shows: Physical world integration with AI agents
  </Tab>
</Tabs>
...
<AccordionGroup>
  ...
  <Accordion title="🔌 Learn Edge Computing & IoT">
    ...
    **Learn:** Edge APIs, Flask on Pi, gpiozero, hardware control via chat, scheduled automation
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="⭐⭐ Intermediate (7 demos)">
