...
description: "Complete shopping experience using Lua Platform APIs"
---
...
<Note>
**v3.0.0 Pattern:** This demo now uses `LuaAgent` to configure the agent's persona, welcome message, and skills in one unified structure.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Complete Flow" icon="cart-shopping">
...
<Card title="Customer Support Agent" icon="headset" href="/demos/customer-support">
