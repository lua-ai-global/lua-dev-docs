...
description: "Reservation management with Lua Data API"
---
...
<CardGroup cols={2}>
  <Card title="Lua Data API" icon="database">
    Stores rooms and reservations
  </Card>
  <Card title="Vector Search" icon="magnifying-glass">
    Search reservations by guest info
  </Card>
  <Card title="Date Logic" icon="calendar">
    Availability checking
  </Card>
  <Card title="Confirmation Codes" icon="ticket">
