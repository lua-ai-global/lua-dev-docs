...
The template creates a well-organized project structure designed for building AI agents efficiently.
...
<Note>
**v3.0.0 Structure:** Projects now use `LuaAgent` in `src/index.ts` for unified configuration. Optional folders for webhooks, jobs, and processors are created as needed.
</Note>
...
<Tabs>
  <Tab title="index.ts">
    **Agent configuration - Define your agent here (v3.0.0)**
    ...
    - Configure your agent with LuaAgent
    - Export the agent
  </Tab>
